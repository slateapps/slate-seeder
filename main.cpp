...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Slate-Seeder\n"
...
static const string mainnet_seeds[] = {"main.seeder.slate.host", ""};
static const string testnet_seeds[] = {"testnet.seeder.slate.host",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("slatevj7kcklujarx.onion", 37415), true);
  }
  do {
